...
public class MinistereHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, AdmissionPostLicence.Ministere t)
    {
     ...
     */
    public static AdmissionPostLicence.Ministere extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return AdmissionPostLicence.MinistereHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:AdmissionPostLicence/Ministere:1.0";
     ...
     */
    public static AdmissionPostLicence.Ministere read(org.omg.CORBA.portable.InputStream istream)
    {
        return(AdmissionPostLicence.Ministere)istream.read_Object(AdmissionPostLicence._MinistereStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, AdmissionPostLicence.Ministere value)
    {
