...
public class RectoratHelper
{
    ...
    public static AdmissionPostLicence.Rectorat extract(org.omg.CORBA.Any a)
    {
        ...
        try {
            return AdmissionPostLicence.RectoratHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:AdmissionPostLicence/Rectorat:1.0";
    ...
    {
        return(AdmissionPostLicence.Rectorat)istream.read_Object(AdmissionPostLicence._RectoratStub.class);
    }
